...
public class Department {
    ...
    */
    ...
    public String toString() {
        String departementTexte = "";
        departementTexte += "Le département est " + this.name + ". Il contient les employes : ";
        foreach(String employe : this.employees) {
            departementTexte += employe.getName() + ", ";
        }
        departementTexte += ".";
        return departementTexte;
    }
